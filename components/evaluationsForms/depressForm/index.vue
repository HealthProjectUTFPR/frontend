<template>
  <el-card class="box-card">
    <template #header>
      <div class="flex h-full w-full justify-center">
        <span class="text-center"
          ><strong>Escala de Depressão Geriátrica (GDS-15)</strong></span
        >
      </div>
    </template>
    ...
    >
      ...
      <el-form-item label="4. Você se aborrece com frequência ?" prop="campo4">
        <el-switch
      ...
      <el-form-item label="13. Você se sente cheio de energia ?" prop="campo13">
        <el-switch
...
export default {
  ...
  computed: {
    total() {
      return (
        this.depressionForm.campo1 +
        this.depressionForm.campo2 +
        this.depressionForm.campo3 +
        this.depressionForm.campo4 +
        this.depressionForm.campo5 +
        this.depressionForm.campo6 +
        this.depressionForm.campo7 +
        this.depressionForm.campo8 +
        this.depressionForm.campo9 +
        this.depressionForm.campo10 +
        this.depressionForm.campo11 +
