    ...
    async getGraph() {
      ...
      if(this.value !== null) {
        ...
        data.data.forEach(d => {
          ...
          if(DateDate.getTime() >= DateInitial.getTime() && DateDate.getTime() <= DateFinal.getTime()) {
        ...
        if(Object.keys(this.arrav1).length === 0 && Object.keys(this.arrav2).length === 0 && Object.keys(this.arrav3).length === 0 && Object.keys(this.arrav4).length === 0 && Object.keys(this.arrav5).length === 0 && Object.keys(this.arrav6).length === 0 && Object.keys(this.arrav7).length === 0 && Object.keys(this.arrav8).length === 0 && Object.keys(this.arrav9).length === 0) {
          this.emptyGraph()
        } else {
