<template>
    <div class = "h-screen w-screen">
        <div class = "image flex justify-center pt-36">
        ...
        <div class = "LoginForm pt-10 m-auto w-80"> 
            <el-form ref="LoginForm" :model="login" :rules="rules">
                <el-form-item prop="email">
                    <el-input v-model="login.email" clearable="true" type="email" placeholder="Insira seu email"/>
                </el-form-item>
                <el-form-item prop="password">
                    <el-input v-model="login.password" show-password="true" placeholder="Insira sua senha" ></el-input>
                </el-form-item>
                <el-form-item>
                    <el-link type="primary" :underline="false" ><span class = "forgot text-xs px-24">Esqueceu sua senha?</span></el-link>
                </el-form-item>
            </el-form>
        </div>
        <div class="button pt-6 flex justify-center">
